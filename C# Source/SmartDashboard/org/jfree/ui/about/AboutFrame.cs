...
// Type: org.jfree.ui.about.AboutFrame
...
{
  [Serializable]
  public class AboutFrame : JFrame
  {
    ...
    public static Dimension PREFERRED_SIZE
    {
      [HideFromJava] get
      {
        return AboutFrame.__\u003C\u003EPREFERRED_SIZE;
      }
    }
    ...
    public static Border STANDARD_BORDER
    {
      [HideFromJava] get
      {
        return AboutFrame.__\u003C\u003ESTANDARD_BORDER;
      }
    }

    [LineNumberTable(new byte[] {(byte) 159, (byte) 123, (byte) 133, (byte) 180})]
    static AboutFrame()
    {
      JFrame.__\u003Cclinit\u003E();
      AboutFrame.__\u003C\u003EPREFERRED_SIZE = new Dimension(560, 360);
      AboutFrame.__\u003C\u003ESTANDARD_BORDER = BorderFactory.createEmptyBorder(5, 5, 5, 5);
    }

    [LineNumberTable(new byte[] {(byte) 99, (byte) 137, (byte) 103, (byte) 103, (byte) 104, (byte) 104, (byte) 104, (byte) 104, (byte) 136, (byte) 102, (byte) 144, (byte) 112, (byte) 139, (byte) 105, (byte) 104, (byte) 135, (byte) 136})]
    ...
    [LineNumberTable(new byte[] {(byte) 66, (byte) 255, (byte) 46, (byte) 74})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    protected AboutFrame([In] SerializationInfo obj0, [In] StreamingContext obj1)
    {
      base.\u002Ector(obj0, obj1);
    }
    ...
    [LineNumberTable(new byte[] {(byte) 160, (byte) 77, (byte) 134, (byte) 104, (byte) 107, (byte) 145, (byte) 137, (byte) 102, (byte) 107, (byte) 146, (byte) 138})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private JTabbedPane createTabs([In] ProjectInfo obj0)
    {
      JTabbedPane jtabbedPane = new JTabbedPane();
      JPanel aboutPanel = this.createAboutPanel(obj0);
      ((JComponent) aboutPanel).setBorder(AboutFrame.__\u003C\u003ESTANDARD_BORDER);
      ...
      ((JComponent) systemPropertiesPanel).setBorder(AboutFrame.__\u003C\u003ESTANDARD_BORDER);
      string string2 = this.resources.getString("about-frame.tab.system");
      jtabbedPane.add(string2, (Component) systemPropertiesPanel);
      return jtabbedPane;
    }

    [LineNumberTable(new byte[] {(byte) 160, (byte) 106, (byte) 144, (byte) 191, (byte) 10, (byte) 98, (byte) 134, (byte) 104, (byte) 146, (byte) 108, (byte) 146, (byte) 107, (byte) 162, (byte) 104, (byte) 104, (byte) 108, (byte) 146, (byte) 107, (byte) 162, (byte) 99, (byte) 104, (byte) 108, (byte) 146, (byte) 107, (byte) 162, (byte) 108, (byte) 99, (byte) 168})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    private JPanel createAboutPanel([In] ProjectInfo obj0)
    {
      ...
      if (this.contributors != null)
      {
        ...
        ((JComponent) contributorsPanel).setBorder(AboutFrame.__\u003C\u003ESTANDARD_BORDER);
      ...
      if (this.licence != null)
      {
        ...
        ((JComponent) licencePanel).setBorder(AboutFrame.__\u003C\u003ESTANDARD_BORDER);
      ...
      if (obj0 != null)
      {
        ...
        ((JComponent) libraryPanel).setBorder(AboutFrame.__\u003C\u003ESTANDARD_BORDER);
    ...
    [LineNumberTable(new byte[] {(byte) 160, (byte) 158, (byte) 112, (byte) 113, (byte) 103, (byte) 103, (byte) 103, (byte) 103, (byte) 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
