...
// Type: org.jfree.data.resources.DataPackageResources
...
{
  public class DataPackageResources : ListResourceBundle
  {
    [Modifiers]
    private static object[][] CONTENTS;

    [LineNumberTable((ushort) 62)]
    static DataPackageResources()
    {
      ...
      DataPackageResources.CONTENTS = objArray1;
    }
