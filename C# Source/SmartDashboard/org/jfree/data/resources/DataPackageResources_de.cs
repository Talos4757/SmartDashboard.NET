...
// Type: org.jfree.data.resources.DataPackageResources_de
...
{
  public class DataPackageResources_de : ListResourceBundle
  {
    [Modifiers]
    private static object[][] CONTENTS;

    [LineNumberTable((ushort) 62)]
    static DataPackageResources_de()
    {
      ...
      int index6 = 1;
      string str4 = "Kategorien";
      objArray3[index6] = (object) str4;
      objArray1[index4] = objArray3;
      DataPackageResources_de.CONTENTS = objArray1;
    }
    ...
    {
      return DataPackageResources_de.CONTENTS;
    }
  }
}
