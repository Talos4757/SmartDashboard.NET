...
// Type: edu.wpi.first.wpilibj.networktables2.type.DefaultEntryTypes$1
...
namespace edu.wpi.first.wpilibj.networktables2.type
{
  ...
  [SourceFile(null)]
  internal sealed class DefaultEntryTypes\u00241 : NetworkTableEntryType
  {
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal DefaultEntryTypes\u00241([In] byte obj0, [In] string obj1)
      : base(obj0, obj1)
    {
    }
    ...
    public override void sendValue([In] object obj0, [In] DataOutputStream obj1)
    {
      if (obj0 is Boolean)
      {
        obj1.writeBoolean(((Boolean) obj0).booleanValue());
      }
      else
      {
