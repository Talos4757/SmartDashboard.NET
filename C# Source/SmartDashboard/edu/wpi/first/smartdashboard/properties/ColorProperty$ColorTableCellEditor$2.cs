...
// Type: edu.wpi.first.smartdashboard.properties.ColorProperty$ColorTableCellEditor$2
...
namespace edu.wpi.first.smartdashboard.properties
{
  ...
  [Modifiers]
  internal sealed class ColorProperty\u0024ColorTableCellEditor\u00242 : Object, ActionListener, EventListener
  {
    [Modifiers]
    ...
    internal ColorProperty\u0024ColorTableCellEditor\u00242([In] ColorProperty.ColorTableCellEditor obj0, [In] ColorProperty obj1)
    {
      base.\u002Ector();
    }

    [LineNumberTable(new byte[] {(byte) 44, (byte) 109})]
    [MethodImpl(MethodImplOptions.NoInlining)]
