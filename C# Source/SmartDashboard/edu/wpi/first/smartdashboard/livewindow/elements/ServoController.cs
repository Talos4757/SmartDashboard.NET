...
// Type: edu.wpi.first.smartdashboard.livewindow.elements.ServoController
...
namespace edu.wpi.first.smartdashboard.livewindow.elements
{
  ...
  [Serializable]
  public class ServoController : AbstractTableWidget, Controller
  {
    ...
    public static DataType[] TYPES
    {
      [HideFromJava] get
      {
        return ServoController.__\u003C\u003ETYPES;
      }
    }
    ...
    [LineNumberTable(new byte[] {(byte) 159, (byte) 169, (byte) 232, (byte) 70, (byte) 144, (byte) 107, (byte) 107})]
    ...
    protected ServoController([In] SerializationInfo obj0, [In] StreamingContext obj1)
      : base(obj0, obj1)
    {
    }
    ...
    internal static JButton access\u0024000([In] ServoController obj0)
    {
      return obj0.zeroButton;
    }

    [LineNumberTable(new byte[] {(byte) 44, (byte) 112, (byte) 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    [LineNumberTable(new byte[] {(byte) 159, (byte) 183, (byte) 150, (byte) 118, (byte) 112, (byte) 112, (byte) 112, (byte) 108, (byte) 109, (byte) 140, (byte) 112, (byte) 140, (byte) 159, (byte) 0, (byte) 241, (byte) 73, (byte) 108, (byte) 241, (byte) 70, (byte) 107, (byte) 102, (byte) 103, (byte) 103, (byte) 109, (byte) 103, (byte) 108, (byte) 109, (byte) 108, (byte) 103, (byte) 109, (byte) 103, (byte) 109, (byte) 135})]
    [MethodImpl(MethodImplOptions.NoInlining)]
