...
// Type: edu.wpi.first.smartdashboard.types.named.GyroType
...
{
  public class GyroType : NamedDataType
  {
    public const string LABEL = "Gyro";
    ...
    private GyroType()
      : base("Gyro", (Class) ClassLiteral<Compass>.Value, new DataType[0])
    {
    }
    ...
    {
      if (NamedDataType.get("Gyro") != null)
        return NamedDataType.get("Gyro");
      else
        return (NamedDataType) new GyroType();
    }
  }
}
