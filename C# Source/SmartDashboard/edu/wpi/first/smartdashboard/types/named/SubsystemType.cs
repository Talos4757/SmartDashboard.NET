...
// Type: edu.wpi.first.smartdashboard.types.named.SubsystemType
...
{
  public class SubsystemType : NamedDataType
  {
    public const string LABEL = "Subsystem";
    ...
    private SubsystemType()
      : base("Subsystem", (Class) ClassLiteral<Subsystem>.Value, new DataType[0])
    {
    }
    ...
    {
      if (NamedDataType.get("Subsystem") != null)
        return NamedDataType.get("Subsystem");
      else
        return (NamedDataType) new SubsystemType();
    }
  }
}
