...
// Type: edu.wpi.first.smartdashboard.gui.DashboardMenu$3
...
namespace edu.wpi.first.smartdashboard.gui
{
  ...
  [Modifiers]
  internal sealed class DashboardMenu\u00243 : Object, ActionListener, EventListener
  {
    [Modifiers]
    ...
    internal DashboardMenu\u00243([In] DashboardMenu obj0, [In] DashboardFrame obj1)
    {
      base.\u002Ector();
    }

    [LineNumberTable(new byte[] {(byte) 19, (byte) 127, (byte) 8})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void actionPerformed([In] ActionEvent obj0)
    {
      this.val\u0024frame.save((string) this.val\u0024frame.getPrefs().__\u003C\u003EsaveFile.getValue());
    }
  }
}
