...
// Type: edu.wpi.first.smartdashboard.gui.elements.Subsystem$SubsystemCommandField$1
...
namespace edu.wpi.first.smartdashboard.gui.elements
{
  ...
  [Modifiers]
  internal sealed class Subsystem\u0024SubsystemCommandField\u00241 : Object, StringBindable
  {
    [Modifiers]
    ...
    internal Subsystem\u0024SubsystemCommandField\u00241([In] Subsystem.SubsystemCommandField obj0, [In] Subsystem obj1)
    {
      base.\u002Ector();
    }

    [LineNumberTable(new byte[] {(byte) 159, (byte) 190, (byte) 109, (byte) 109, (byte) 152, (byte) 114})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void setBindableValue([In] string obj0)
    {
      Subsystem.SubsystemCommandField.access\u0024002(this.this\u00241, obj0);
