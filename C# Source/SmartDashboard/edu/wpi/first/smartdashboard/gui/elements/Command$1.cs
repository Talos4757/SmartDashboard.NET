...
// Type: edu.wpi.first.smartdashboard.gui.elements.Command$1
...
namespace edu.wpi.first.smartdashboard.gui.elements
{
  ...
  [Modifiers]
  internal sealed class Command\u00241 : Object, ActionListener, EventListener
  {
    [Modifiers]
    ...
    internal Command\u00241([In] Command obj0)
    {
      base.\u002Ector();
    }

    [LineNumberTable(new byte[] {(byte) 159, (byte) 185, (byte) 120})]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void actionPerformed([In] ActionEvent obj0)
    {
      Command.access\u0024000(this.this\u00240).putBoolean("running", true);
    }
  }
}
