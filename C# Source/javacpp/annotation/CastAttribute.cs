...
// Type: com.googlecode.javacpp.annotation.CastAttribute
...
namespace com.googlecode.javacpp.annotation
{
  [Modifiers]
  [InnerClass]
  [Implements(new string[] {"com.googlecode.javacpp.annotation.Cast"})]
  [AttributeUsage(AttributeTargets.Method | AttributeTargets.Parameter)]
  public sealed class CastAttribute : AnnotationAttributeBase, Cast
  {
    [EditorBrowsable(EditorBrowsableState.Never)]
    public CastAttribute([In] object[] obj0)
      : this()
    {
    ...
    {
      base.\u002Ector((Class) ClassLiteral<Cast>.Value);
    }
