...
// Type: com.googlecode.javacpp.annotation.Convention
...
namespace com.googlecode.javacpp.annotation
{
  ...
  [Modifiers]
  [AnnotationAttribute("com.googlecode.javacpp.annotation.ConventionAttribute")]
  ...
  public interface Convention : Annotation
  {
    string value();
  }
}
