...
// Type: com.googlecode.javacpp.annotation.Namespace
...
namespace com.googlecode.javacpp.annotation
{
  ...
  [Modifiers]
  [AnnotationAttribute("com.googlecode.javacpp.annotation.NamespaceAttribute")]
  ...
  public interface Namespace : Annotation
  {
    string value();
  }
}
