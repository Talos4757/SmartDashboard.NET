...
// Type: com.googlecode.javacv.cpp.opencv_core$CvMat$1
...
namespace com.googlecode.javacv.cpp
{
  ...
  [EnclosingMethod("com.googlecode.javacv.cpp.opencv_core$CvMat", "createThreadLocal", "(III)Ljava.lang.ThreadLocal;")]
  [SourceFile("opencv_core.java")]
  internal sealed class opencv_core\u0024CvMat\u00241 : ThreadLocal
  {
    [Modifiers]
    ...
    [HideFromJava]
    static opencv_core\u0024CvMat\u00241()
    {
      ThreadLocal.__\u003Cclinit\u003E();
    }

    [LineNumberTable((ushort) 1083)]
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal opencv_core\u0024CvMat\u00241([In] int obj0, [In] int obj1, [In] int obj2)
    {
      base.\u002Ector();
    }
