...
// Type: com.googlecode.javacv.ProCamGeometricCalibrator$3
...
namespace com.googlecode.javacv
{
  ...
  [Modifiers]
  internal sealed class ProCamGeometricCalibrator\u00243 : Object, Runnable
  {
    [Modifiers]
    ...
    internal ProCamGeometricCalibrator\u00243([In] ProCamGeometricCalibrator obj0, [In] int obj1, [In] bool obj2)
    {
      int num = obj2 ? 1 : 0;
      this.this\u00240 = obj0;
    ...
    {
      ProCamGeometricCalibrator.access\u0024200(this.this\u00240);
      int num1 = this.val\u0024cameraNumber;
      MarkerDetector markerDetector = ProCamGeometricCalibrator.access\u0024300(this.this\u00240)[this.val\u0024cameraNumber].markerDetector;
